...
- **Fichier :** `mrnf_cantons_seigneuires.geojson`
...
- **Autorisation :** Le ministère a confirmé directement (contact établi via geoboutique@mrnf.gouv.qc.ca) l'autorisation d'utiliser et de publier ces données dans le cadre de ce projet.
- **Citation :**
...
Les fichiers `Circonscriptions_1792_couche` et `Couche_1820` sont le résultat d'une fusion de ces deux sources, réalisée par Roxanne Corriveau. Voir `scripts/` pour le code de traitement.
